                    ...
                    <div class="banBox">
                        <div class="mnBan">
                            ...
                            <button class="likeBtn">
                                ...
                                <div class="btnIco">
                                    <div class="icoImg" id="heartWhite" onclick="clickLikeBtn('${likes.pj_id}','${userInfo.user_id}','${likes.curr_pj_like_cnt}')">
<%--                                    <div class="icoImg" id="heartWhite">--%>
                                    ...
                                    <div class="icoImg on" id="heartRed" onclick="clickLikeBtn('${likes.pj_id}','${userInfo.user_id}','${likes.curr_pj_like_cnt}')">
