            ...
            <div class="pjForm story">
                <div class="purpose form">
                    ...
                    <div class="textWrp sub">
                        <div class="textCon">
                            <textarea name="pjIntro" id="intro" class="pjStr">${storyForm.pj_intro}</textarea>
                        </div>
                    </div>
                </div>
                <div class="budget form">
                    ...
                    <div class="textWrp sub">
                        <div class="textCon">
                            <textarea name="pjBudget" id="budget" class="pjStr">${storyForm.pj_budget}</textarea>
                        </div>
                    </div>
                </div>
                <div class="sched form">
                    ...
                    <div class="textWrp sub">
                        <div class="textCon">
                            <textarea name="pjSched" id="sched" class="pjStr">${storyForm.pj_sched}</textarea>
                        </div>
                    </div>
                </div>
                <div class="intro form">
                    ...
                    <div class="textWrp sub">
                        <div class="textCon">
                            <textarea name="pjSelIntro" id="selIntro" class="pjStr">${storyForm.pj_sel_intro}</textarea>
                        </div>
                    </div>
                </div>
                <div class="reward form">
                    ...
                    <div class="textWrp sub">
                        <div class="textCon">
                            <textarea name="pjReward" id="reward" class="pjStr">${storyForm.pj_gift_intro}</textarea>
                        </div>
                    </div>
                </div>
            </div>
