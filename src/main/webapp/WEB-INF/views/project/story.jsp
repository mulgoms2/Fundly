...
<%--<html>--%>
<%--<head>--%>
<%--    <script src="https://cdn.tiny.cloud/1/uh0icij1g3eyzvh7ppnwlga6kxke0lnffev72sw6bz89u7rb/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>    <title>Title</title>--%>
<%--</head>--%>
<%--<body>--%>
<%--&lt;%&ndash;<form id="txtForm">&ndash;%&gt;--%>
<%--    <textarea name="pjTxt" id="file-picker">aaa</textarea>--%>
