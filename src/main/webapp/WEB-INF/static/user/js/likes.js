...
function updated(res) {
    ...
    if(res.length !== 0) {
        // 응답을 받아서 HTML 요소로 변환
        const likesTitle = document.getElementById('likesTitleY');
    ...
    // 좋아요 목록이 없다면
        ...
        const likesTitle = document.getElementById('likesTitleY');
        const likesContainer = document.getElementById('projectCardWrap');
        const likesMain = document.getElementById('likesMain');
        ...
        <div class="likesTitle" id="likesTitleY">
            <div class="title">관심 프로젝트</div>
            <span class="likesCnt" style="color: rgb(160, 155, 155)">${res.length}</span>개의 프로젝트를 좋아합니다.
        </div>
        `;
        ...
        // main파트 height 사이즈 줄이기
        // likesMain.style.height = "600px";
    }
}