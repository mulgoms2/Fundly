...
//        로그인한 유저가 채팅방에 접속한다.
        ...
        chatRoom = SelBuyMsgDto.builder()
                               .room_num(1L)
                               .pj_id(chatRequest.getPj_id())
                               .user_id(chatRequest.getBuy_id())
                               .build();
...
//        모델로 전달한 채팅방을 확인한다.
    ...
    void chatPop() throws Exception {
        ChatRequest unLoginedRequest = ChatRequest.builder()
                                                  .buy_id("")
                                                  .pj_id("")
                                                  .build();
        SelBuyMsgDto chatRoom = SelBuyMsgDto.builder()
                                            .room_num(1L)
                                            .pj_id(unLoginedRequest.getPj_id())
                                            .user_id(unLoginedRequest.getBuy_id())
                                            .build();
